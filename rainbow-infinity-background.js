...
function setInfinityColors() {
  ...
  // console.dir(colors);
  // if (colors.length < 8) {
  //   console.log('colors for infinity was less than 8 - filling to 8:');
  //   colors = colors.from({ length: 8 }, (_, index) => arr[index % arr.length]);
  //   console.log(colors);
  // }
  ...
  // elem.style.borderRightColor = colors[0];
