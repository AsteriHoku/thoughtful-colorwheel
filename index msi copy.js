...
function renderStraightLinesCanvas(){
  ...
  console.log('canvas sl: ', canvas);
  console.log('ctx sl: ', ctx);
}
...
function renderLinearGradientCanvas(){
  ...
  console.log('canvas lg: ', canvas);
  console.log('ctx lg: ', ctx);
}
...
function renderDiagonalGradientCanvas(){
  ...
  console.log('canvas dg: ', canvas);
  console.log('ctx dg: ', ctx);
}
...
function renderCircleParticlesCanvas(){
  ...
  const {canvas, ctx, onItems} = getContext();
  console.log('onItems in renderCircles: ', onItems);
  ...
  if (onItems.length > 0) {
    ...
    console.log('canvas cp: ', canvas);
    console.log('ctx cp: ', ctx);

    function generateParticleColors(size, onItems){
      console.log('onItems in generateParticleColors: ', onItems);
